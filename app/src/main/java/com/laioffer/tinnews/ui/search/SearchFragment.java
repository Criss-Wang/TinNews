...
public class SearchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment --> create a view tree from the xml file
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // 1. provider creates new HomeViewModel object
        // 2. provider provides us the same HomeViewModel object as the one before configuration change
        viewModel = new ViewModelProvider(this,
                new NewsViewModelFactory(repository)).get(SearchViewModel.class);

        // [SearchViewModel.class: SearchViewModel object]
        // app: Process, activity: Thread

        // Get NewsResponse LiveData
        // observer observe LiveData<NewsResponse>ß
